...
$(function(){
	...
	menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"11","name":"滑雪场管理","parentId":"1","url":"area_area.do","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
					]},
					{"id":"12","name":"订单管理","parentId":"1","url":"myorder _myorder.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
					]},
					{"id":"13","name":"教练管理","parentId":"1","url":"coach_coach.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
					]},
					{"id":"14","name":"器材管理","parentId":"1","url":"equip_equip.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
					]},
					{"id":"15","name":"会员管理","parentId":"1","url":"tuser_user.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
					]},
					{"id":"15","name":"收银员管理","parentId":"1","url":"cashier_cashier.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[                                                                                                					]}
				]}
				];
	}
	if(roleVal==2){
		menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
  					{"id":"11","name":"滑雪场场地","parentId":"1","url":"area_area1.do","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
                    ]},
  					{"id":"12","name":"订单管理","parentId":"1","url":"myorder _myorder1.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
  					]},
  					{"id":"13","name":"教练查看","parentId":"1","url":"coach_coach1.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
                  	]},
  					{"id":"14","name":"器材查看","parentId":"1","url":"equip_equip1.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
  					]},
  					{"id":"15","name":"会员查看","parentId":"1","url":"tuser_user1.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
  					]}
				]}
				];	
	}
	if(roleVal==1){
		menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
  					{"id":"11","name":"个人信息","parentId":"1","url":"tuser_user2.do?id="+userId,"icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
                    ]},
  					{"id":"12","name":"我的订单","parentId":"1","url":"myorder _myorder2.do","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
  					]}
				]}
				];	 
	}
